...
namespace vast::util {
    ...
    template< typename list >
    constexpr bool is_list_of_lists = is_type_list_v< list > && list::template all_of< is_type_list >;
    ...
    template< typename list >
    requires is_list_of_lists< list >
    ...
    namespace test
    {
        ...
        static_assert( is_list_of_lists< type_list<> > );
