...
// CHEKC: hl.real {{.*}} : {{.*}}!hl.complex<!hl.double>{{.*}} -> !hl.double
    double a = __real__ y;
// CHEKC: hl.imag {{.*}} : {{.*}}!hl.complex<!hl.double>{{.*}} -> !hl.double
    double b = __imag__ y;

// CHEKC: hl.real {{.*}} : {{.*}}!hl.complex<!hl.double>{{.*}} -> !hl.lvalue<!hl.double>
// CHEKC: hl.imag {{.*}} : {{.*}}!hl.complex<!hl.double>{{.*}} -> !hl.lvalue<!hl.double>
    __real__ x = 1;
    __imag__ x = 1;
}
