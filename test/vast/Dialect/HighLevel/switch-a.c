...
int switch_simple(int num)
{
    ...
    switch (num) {
        ...
        // CHECK: } {
        // CHECK: [[V4:%[0-9]+]] = hl.const #hl.integer<1> : !hl.int
        // CHECK: hl.return [[V4]]
        // CHECK: }
        case  2: return 2;
        // CHECK: hl.case {
        // CHECK: [[V5:%[0-9]+]] = hl.const #hl.integer<2> : !hl.int
        // CHECK: hl.value.yield [[V5]]
        // CHECK: } {
        // CHECK: [[V6:%[0-9]+]] = hl.const #hl.integer<2> : !hl.int
        // CHECK: hl.return [[V6]]
        // CHECK: }
        default: return 0;
        // CHECK: hl.default {
        // CHECK: [[V7:%[0-9]+]] = hl.const #hl.integer<0> : !hl.int
        // CHECK: hl.return [[V7]]
        // CHECK: }
    }
    // CHECK: }
...
// CHECK: hl.func external @switch_fallthorugh_1 ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>) -> !hl.int
...
// CHECK: hl.func external @switch_fallthorugh_2 ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>) -> !hl.int
...
// CHECK: hl.func external @switch_nodefault ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>) -> !hl.int
...
// CHECK: hl.func external @switch_break ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>) -> !hl.int
...
// CHECK: hl.func external @switch_block ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>) -> !hl.int
