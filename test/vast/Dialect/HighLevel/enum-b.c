...
int main() {
    ...
    // CHECK:  [[V1:%[0-9]+]] = hl.declref "RED" : !hl.lvalue<!hl.int>
    ...
    switch(r) {
    // CHECK: hl.case
    // CHECK:  hl.declref "RED" : !hl.lvalue<!hl.int>
    case RED:
        puts("red");
        break;
    // CHECK: hl.case
    // CHECK:  hl.declref "GREEN" : !hl.lvalue<!hl.int>
    case GREEN:
        puts("green");
        break;
    // CHECK: hl.case
    // CHECK:  hl.declref "BLUE" : !hl.lvalue<!hl.int>
    case BLUE:
        puts("blue");
        break;
    }
