...
// CHECK: hl.func external @arithemtic_int_short ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.int>, [[A2:%arg[0-9]+]]: !hl.lvalue<!hl.short>) -> !hl.void
void arithemtic_int_short(int a, short b)
{
    int c;
    // CHECK: [[C:%[0-9]+]] = hl.var "c" : !hl.lvalue<!hl.int>
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.int>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.int>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.int> -> !hl.int
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.short>
    ...
    c = a + b;
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.int>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.short>
    ...
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.int>
...
void arithemtic_int_long(int a, long b)
{
    ...
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.long>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.int>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.int> -> !hl.int
    // CHECK: [[V3:%[0-9]+]] = hl.implicit_cast [[V2]] IntegralCast : !hl.int -> !hl.long
    // CHECK: [[V4:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.long>
...
void arithemtic_short_long(short a, long b)
{
    ...
    // CHECK: [[C:%[0-9]+]] = hl.var "c" : !hl.lvalue<!hl.long>
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.long>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.short>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.short> -> !hl.short
    ...
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.long>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.long> -> !hl.long
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.short>
    // CHECK: [[V4:%[0-9]+]] = hl.implicit_cast [[V3]] LValueToRValue : !hl.lvalue<!hl.short> -> !hl.short
...
void arithemtic_pointer_short(int* a, short b)
{
    ...
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.ptr<!hl.int>>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.ptr<!hl.int>>
    ...
    // CHECK: [[V4:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.ptr<!hl.int>>
...
void arithemtic_pointer_long(int* a, long b)
{
    ...
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.long>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.long> -> !hl.long
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.ptr<!hl.int>>
