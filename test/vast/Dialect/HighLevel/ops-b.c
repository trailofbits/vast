...
{
    // CHECK: [[V1:%[0-9]+]] = hl.declref [[A1]] : !hl.lvalue<!hl.int>
    // CHECK: [[V2:%[0-9]+]] = hl.declref [[A2]] : !hl.lvalue<!hl.int>
...
{
    // CHECK: [[V1:%[0-9]+]] = hl.declref [[A1]] : !hl.lvalue<!hl.int<unsigned>>
    // CHECK: [[V2:%[0-9]+]] = hl.declref [[A2]] : !hl.lvalue<!hl.int<unsigned>>
