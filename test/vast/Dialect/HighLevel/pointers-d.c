...
void f(int);
// CHECK: hl.var @pf1, <external> : !hl.lvalue<!hl.ptr<!hl.paren<!core.fn<(!hl.lvalue<!hl.int>) -> (!hl.void)>>>>
...
void (*pf1)(int) = &f;
// CHECK: hl.var @pf2, <external> : !hl.lvalue<!hl.ptr<!hl.paren<!core.fn<(!hl.lvalue<!hl.int>) -> (!hl.void)>>>>
// CHECK:   [[R:%[0-9]+]] = hl.funcref @f : !core.fn<(!hl.lvalue<!hl.int>) -> (!hl.void)>
