...
// CHECK: hl.struct "v"
struct v {
   // CHECK: hl.union "v::[[N1:anonymous\[[0-9]+\]]]"
   union { // anonymous union
      // CHECK: hl.struct "v::[[N1]]::[[N2:anonymous\[[0-9]+\]]]"
      // CHECK:    hl.field "i" : !hl.int
      // CHECK:    hl.field "j" : !hl.int
      // CHECK: hl.field "[[N3:anonymous\[[0-9]+\]]]" : !hl.record<"v::[[N1]]::[[N2]]">
      struct { int i, j; }; // anonymous structure
      // CHECK: hl.struct "v::[[N1]]::[[N4:anonymous\[[0-9]+\]]]"
      // CHECK:   hl.field "k" : !hl.long
      // CHECK:   hl.field "l" : !hl.long
      // CHECK: hl.field "w" : !hl.elaborated<!hl.record<"v::[[N1]]::[[N4]]">>
      struct { long k, l; } w;
   };
   // CHECK: hl.field "[[N5:anonymous\[[0-9]+\]]]" : !hl.record<"v::[[N1]]">
...
int main() {
   ...
   // CHECK: [[V1:%[0-9]+]] = hl.globref "v1" : !hl.lvalue<!hl.elaborated<!hl.record<"v">>>
   // CHECK: [[V2:%[0-9]+]] = hl.member [[V1]] at "[[N5]]" : !hl.lvalue<!hl.elaborated<!hl.record<"v">>> -> !hl.lvalue<!hl.record<"v::[[N1]]">>
   // CHECK: [[V3:%[0-9]+]] = hl.member [[V2]] at "w" : !hl.lvalue<!hl.record<"v::[[N1]]">> -> !hl.lvalue<!hl.elaborated<!hl.record<"v::[[N1]]::[[N4]]">>>
   // CHECK: [[V4:%[0-9]+]] = hl.member [[V3]] at "k" : !hl.lvalue<!hl.elaborated<!hl.record<"v::[[N1]]::[[N4]]">>> -> !hl.lvalue<!hl.long>
   v1.w.k = 5;
}
