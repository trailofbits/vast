...
// CHECK: hl.typedef "function_pointer_t" : !hl.ptr<!hl.paren<(!hl.lvalue<!hl.int>) -> !hl.void>>
typedef void (*function_pointer_t)(int); // <-- this creates a function pointer type
// CHECK: hl.typedef "function_t" : (!hl.lvalue<!hl.int>) -> !hl.void
typedef void function_t(int); // <-- this creates a function type

// CHECK: hl.func external @my_func (!hl.lvalue<!hl.int>) -> !hl.void
