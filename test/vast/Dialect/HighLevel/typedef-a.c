...
typedef int INT;
typedef short SHORT;
// CHECK: hl.func external @arithemtic_int_short ([[A1:%arg[0-9]+]]: !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>, [[A2:%arg[0-9]+]]: !hl.lvalue<!hl.elaborated<!hl.typedef<"SHORT">>>)
void arithemtic_int_short(INT a, SHORT b)
{
    INT c;
    // CHECK: [[C:%[0-9]+]] = hl.var "c" : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>> -> !hl.elaborated<!hl.typedef<"INT">>
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    ...
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    // CHECK: [[V2:%[0-9]+]] = hl.implicit_cast [[V1]] LValueToRValue : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>> -> !hl.elaborated<!hl.typedef<"INT">>
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"SHORT">>>
    ...
    c = a + b;
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"INT">>>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A2]] : !hl.lvalue<!hl.elaborated<!hl.typedef<"SHORT">>>
...
void arithemtic_pointer_long(INT* a, long b)
{
    ...
    // CHECK: [[CR:%[0-9]+]] = hl.ref [[C]] : !hl.lvalue<!hl.ptr<!hl.elaborated<!hl.typedef<"INT">>>>
    // CHECK: [[V1:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.ptr<!hl.elaborated<!hl.typedef<"INT">>>>
    ...
    // CHECK: [[V3:%[0-9]+]] = hl.ref [[A1]] : !hl.lvalue<!hl.ptr<!hl.elaborated<!hl.typedef<"INT">>>>
