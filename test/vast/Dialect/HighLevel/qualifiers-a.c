...
// CHECK: [[C1:%[0-9]+]] = hl.constant(#hl.int<0>) : !hl.int
// CHECK: hl.value.yield [[C1]]
const int ci = 0;

// CHECK: hl.global @cui : !hl.int<unsigned const> = {
// CHECK: [[C2:%[0-9]+]] = hl.constant(#hl.int<0>) : !hl.int<unsigned>
...
// CHECK: [[C3:%[0-9]+]] = hl.constant(#hl.int<0>) : !hl.int
// CHECK: hl.value.yield [[C3]]
const volatile int cvi = 0;

// CHECK: hl.global @cvui : !hl.int<unsigned const volatile> = {
// CHECK: [[C4:%[0-9]+]] = hl.constant(#hl.int<0>) : !hl.int<unsigned>
...
// CHECK: [[C5:%[0-9]+]] = hl.constant(#hl.bool<false>) : !hl.bool
// CHECK: hl.value.yield [[C5]]
const bool cb = false;

// CHECK: hl.global @cvb : !hl.bool<const volatile> = {
// CHECK: [[C6:%[0-9]+]] = hl.constant(#hl.bool<true>) : !hl.bool
