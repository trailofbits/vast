...
int main()
{
    // CHECK: [[V0:%[0-9]+]] = hl.var "var_a" : !hl.lvalue<!hl.named_type<"struct X">>
    // CHECK: [[V1:%[0-9]+]] = hl.decl.ref [[V0]] : !hl.lvalue<!hl.named_type<"struct X">>
    // CHECK: [[V2:%[0-9]+]] = hl.member [[V1]] at "member_x" : !hl.lvalue<!hl.named_type<"struct X">> -> !hl.lvalue<i32>
    // CHECK: [[V3:%[0-9]+]] = hl.constant.int 1 : i32
    // CHECK: [[V4:%[0-9]+]] = hl.assign [[V3]] to [[V2]] : i32
    // CHECK: [[V5:%[0-9]+]] = hl.decl.ref [[V0]] : !hl.lvalue<!hl.named_type<"struct X">>
    // CHECK: [[V6:%[0-9]+]] = hl.member [[V5]] at "member_y" : !hl.lvalue<!hl.named_type<"struct X">> -> !hl.lvalue<i32>
