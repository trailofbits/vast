...
// LTYPES: hl.var @Curl_cmalloc, <external> : !hl.lvalue<!hl.elaborated<!hl.typedef<@curl_malloc_callback>>> = {

// LTYPEDEFS: hl.var @Curl_cmalloc, <external> sc_extern : !hl.lvalue<!hl.ptr<!core.fn<(!hl.lvalue<ui64>) -> (!hl.ptr<ui8>)>>>
// LTYPEDEFS: hl.var @Curl_cmalloc, <external> : !hl.lvalue<!hl.ptr<!core.fn<(!hl.lvalue<ui64>) -> (!hl.ptr<ui8>)>>> = {
